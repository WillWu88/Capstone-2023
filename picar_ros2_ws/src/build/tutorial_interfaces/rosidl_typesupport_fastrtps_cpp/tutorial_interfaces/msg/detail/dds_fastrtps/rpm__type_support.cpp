...
#include "tutorial_interfaces/msg/detail/rpm__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tutorial_interfaces::msg::RPM & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::msg::RPM & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::msg::RPM *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::msg::RPM *>(
    untyped_ros_message);
...
{
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_RPM__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, msg, RPM)() {
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_RPM__handle;
}
