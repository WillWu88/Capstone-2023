...
class GPS(metaclass=Metaclass_GPS):
    ...
    def __init__(self, **kwargs):
        ...
        self.latdeg = kwargs.get('latdeg', float())
        self.longdeg = kwargs.get('longdeg', float())
        self.latmin = kwargs.get('latmin', float())
        self.longmin = kwargs.get('longmin', float())
    ...
    def __eq__(self, other):
        ...
        if self.longdeg != other.longdeg:
            return False
        if self.latmin != other.latmin:
            return False
        if self.longmin != other.longmin:
            return False
    ...
    @property
    def latdeg(self):
        """Message field 'latdeg'."""
        return self._latdeg

    @latdeg.setter
    def latdeg(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'latdeg' field must be of type 'float'"
        self._latdeg = value

    @property
    def longdeg(self):
        """Message field 'longdeg'."""
        return self._longdeg

    @longdeg.setter
    def longdeg(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'longdeg' field must be of type 'float'"
        self._longdeg = value

    @property
    def latmin(self):
        """Message field 'latmin'."""
        return self._latmin
    ...
    def latmin(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'latmin' field must be of type 'float'"
        self._latmin = value

    @property
    def longmin(self):
        """Message field 'longmin'."""
        return self._longmin

    @longmin.setter
    def longmin(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'longmin' field must be of type 'float'"
        self._longmin = value
